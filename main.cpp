...
//*****************************************************************************
	...
	{
		model_build( images, labels, image_descriptors);
...
//*****************************************************************************
	...
	if( model_SURF_test_run ==1)
	{
		model_SURF_test	(images, labels, actual_labels, predicted_labels);
