...
void model_build(vector<Mat> images, vector<int> labels,   vector<Mat>& descriptors_image;
)
{
  ...
  {
    surf->detectAndCompute(images[i], images[i], keypoints_scene,  descriptors_scene, params);
    descriptors_image.push_back(descriptors_scene);
  }
